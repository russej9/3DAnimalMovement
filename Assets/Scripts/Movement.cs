...
public class Movement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string[] csvFile = File.ReadAllLines(filePath); //reads csv into string array, each entry is one line
        string[] line;
        ...
        for (int i = 1; i < csvFile.Length; i++) //goes through the UTM coordinates
        {
            ...
            if (line[north] != "0.0")
            {
                ...
                tempList[i].time = System.DateTime.ParseExact(line[timestamp], "yyyy-MM-dd HH:mm:ss", CultureInfo.InvariantCulture); //Parses 2019-06-23 23:16:01
